...
class Bisection extends Component {
  ...
  render() {
    return (
      <div className="Bisection" id="Graph">
        <Header />
        ...
        <Container>
          <Row>
            <Col sm="12" md={{ size: 6, offset: 3 }}>
              <InputGroup>
                ...
                <Input type="text" name="fx" placeholder="x^4-13" value={this.state.fx} onChange={this.handleChange} />
              </InputGroup>
              <br />
              <InputGroup>
                <InputGroupAddon addonType="prepend">
                ...
                <Input type="number" name="xl" placeholder="1.5" onChange={this.handleChange} />
              </InputGroup>
              <br />
              <InputGroup>
                <InputGroupAddon addonType="prepend">
                ...
                <Input type="number" name="xr" placeholder="2.0" onChange={this.handleChange} />
              </InputGroup>
              <br />
          ...
          {this.state.showGraph &&
            <Chart chartData={this.state.chartData} name="Bisection Method" legendPosition="bottom" />
          }
          {this.state.showFunc &&
            <div style={{ backgroundColor: "White" }}>{this.ShowFunc()}</div>
          }
        </Container>

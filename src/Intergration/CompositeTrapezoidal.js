...
class CompositeTrapezoidal extends Component {
    data() {
        axios.get('http://localhost:4000/composite').then(res => {
          ...
          this.forceUpdate();
          this.CompositeTrapezoidal(Number(this.state.a), Number(this.state.b), Number(this.state.n));
        });
    }
    constructor() {
        super();
    ...
    handleSubmit(event) {
        ...
        //console.log(this.state.fx);
        this.CompositeTrapezoidal(parseFloat(this.state.a), parseFloat(this.state.b), parseFloat(this.state.n));
    }
    ...
    CompositeTrapezoidal(a, b, n) {
        ...
        var Ical = (h / 2) * (this.func(a) + this.func(b) + (2*sum))
    ...
    render() {
        return (
            ...
            <div className="App">
                <Header />
                <h1 style={{ textAlign: "center" }}>This is CompositeTrapezoidal page</h1>
                <br />
                <Container>
                    <Row>
